...
$query3 = "SELECT Nombre,ApP,ApM FROM Usuarios WHERE Usuario = '$_SESSION[login]'" ;
                ...
                <div class="row">
                    <div class="col-lg-12 ">
                        <div class="alert alert-info">
                             <strong>Bienvenido <?php echo $_SESSION['login'];?>! </strong> 
                        </div>
                          ...
                          <form class="needs-validation" name="form_01"  method="POST">
                              <div class="form-row">
                                ...
                                <div class="col-md-4 mb-3">
                                  ...
                                  <input type="text" readonly value="<?php echo $_SESSION['login']?>" class="form-control" id="validationTooltipUsername" name="user" placeholder="Usuario" aria-describedby="validationTooltipUsernamePrepend" required>
                                  </div>
                                </div>
                                <div class="col-md-4 mb-3">
                              ...
                              <div class="form-row">
                                ...
                                <div class="col-md-3 mb-3" >
                                  <label  >Nº de caja</label><br>
                                  <input  type="text" class="form-control" value="<?php echo $caja; ?>" maxlength="8" onkeyup="mayus(this);" name="caja" placeholder="Ingrese la caja   " >
                            ...
                            <div class="form-row" id="datos">
                                ...
                                <textarea name="textarea" readonly rows="10" cols="50"><?php 
                                                              if (isset($_POST['buscar'])) {
