            ...
            <div class="navbar navbar-inverse navbar-fixed-top">
                <div class="adjust-nav">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand ">Sperto Digital V 1.00</a>
                    </div>              
            ...
            <div id="page-wrapper" >
                <div id="page-inner">
                    ...
                    <div class="row">
                        <div class="col-lg-12 ">
                            <div class="alert alert-info">
                                <strong>Bienvenido <?php echo $_SESSION['loginudeg'];?>! </strong> 
                            </div>                       
                        </div>
                    </div>
                    <!-- /. ROW  --> 
                    <div class="row text-center pad-top">     
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-6">
                            <div class="div-square">
                                <a href="../captura.php" target="popup" onClick="window.open(this.href, this.target, width=1280px,height=720); return false; window.close(); ">
